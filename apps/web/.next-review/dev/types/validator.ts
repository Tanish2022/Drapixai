...
// Validate ../../../app/api/dashboard/session/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/dashboard/session">> = Specific
  const handler = {} as typeof import("../../../app/api/dashboard/session/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
