...
const opensslVex = read('deploy/security/vex/openssl-3.0-cve-2026-14456.openvex.json');
...
assertIncludes(opensslVex, 'CVE-2026-14456', 'The reviewed OpenSSL VEX declaration must identify the scanner finding exactly.');
assertIncludes(opensslVex, 'libssl3@3.0.20-1~deb12u2', 'The OpenSSL VEX declaration must remain pinned to the reviewed package version.');
assertIncludes(opensslVex, 'vulnerable_code_not_present', 'The OpenSSL VEX declaration must record why OpenSSL 3.0 is not affected.');
