...
The script loads the dashboard proxy token from the API env file generated by `setup-sdk-api-stack.sh`, then fails if SDK quality is more than `0.03` below direct quality.
