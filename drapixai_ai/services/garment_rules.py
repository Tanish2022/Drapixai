...
GARMENT_RULES: tuple[GarmentRule, ...] = (
    GarmentRule(
        key="jeans",
        label="Jeans",
        support_level="future_lower_beta",
        aliases=("jeans", "denim jeans", "denim pants"),
        min_fg_ratio=0.10,
        max_fg_ratio=0.86,
    ...
    GarmentRule(
        ...
        label="Pants",
        support_level="future_lower_beta",
        aliases=("pants", "chinos", "slacks", "bottoms"),
        min_fg_ratio=0.10,
        max_fg_ratio=0.86,
        max_aspect_ratio=2.85,
        crop_padding_ratio=0.10,
    ...
    GarmentRule(
        ...
        label="Trousers",
        support_level="future_lower_beta",
        aliases=("trousers", "trouser", "formal trousers", "dress pants"),
        min_fg_ratio=0.10,
        max_fg_ratio=0.84,
        max_aspect_ratio=2.95,
        crop_padding_ratio=0.09,
        skin_ratio_threshold=0.025,
        top_skin_ratio_threshold=0.05,
    ),
    GarmentRule(
        key="shorts",
        label="Shorts",
        support_level="future_lower_beta",
        aliases=("shorts", "denim shorts", "athletic shorts"),
        min_fg_ratio=0.08,
        max_fg_ratio=0.80,
        max_aspect_ratio=1.75,
        crop_padding_ratio=0.12,
        skin_ratio_threshold=0.04,
        top_skin_ratio_threshold=0.06,
    ),
    GarmentRule(
        key="skirt",
        label="Skirt",
        support_level="future_lower_beta",
        aliases=("skirt", "mini skirt", "pencil skirt", "a line skirt"),
        min_fg_ratio=0.08,
        max_fg_ratio=0.82,
    ...
    GarmentRule(
        ...
        label="Leggings",
        support_level="future_lower_beta",
        aliases=("leggings", "tights", "yoga pants"),
        min_fg_ratio=0.08,
        max_fg_ratio=0.84,
    ...
    GarmentRule(
        ...
        label="Joggers",
        support_level="future_lower_beta",
        aliases=("joggers", "sweatpants", "track pants"),
        min_fg_ratio=0.10,
        max_fg_ratio=0.86,
        max_aspect_ratio=2.95,
        crop_padding_ratio=0.10,
