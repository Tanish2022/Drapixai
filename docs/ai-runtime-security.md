...
Production Compose uses only the digest-pinned `pytorch/pytorch:2.11.0-cuda12.8-cudnn9-devel@sha256:53ab3de62f6101d1e42f9be28623ab7a468a24c070d632f211ed576e30b6abd3` runtime. The Dockerfile asserts its Python 3.12, Torch 2.11, TorchVision 0.26, and CUDA 12.8 contract during build; `deploy/workstation/preflight.sh` also rejects an RTX host with an NVIDIA driver older than 570.
